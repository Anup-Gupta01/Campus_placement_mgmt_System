      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/admin/dashboard" className="flex items-center gap-2.5 group flex-shrink-0">
            <div className="w-9 h-9 bg-[#111827] rounded-xl flex items-center justify-center shadow-sm shadow-black/15 group-hover:shadow-black/20 transition-shadow">
              <GraduationCap className="w-5 h-5 text-white" />
            </div>
            <div className="hidden sm:block">
              <p className="text-[14px] font-extrabold text-slate-900 leading-none tracking-tight">PlacementPro</p>
              <p className="text-[10px] text-emerald-600 font-bold mt-0.5">TnP Admin</p>
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <Link
              ...
              className="ml-2 px-4 py-2 text-[13px] font-bold text-white bg-[#1F2937] rounded-lg shadow-sm shadow-black/10 hover:bg-[#111827] transition-all flex items-center gap-1.5"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={dropRef}>
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-[#111827] flex items-center justify-center text-white text-[12px] font-extrabold shadow-sm shadow-black/10 flex-shrink-0">
                  {initials}
                </div>
                {admin && (
                  <div className="hidden md:block text-left">
                    <p className="text-[12px] font-bold text-slate-800 leading-tight capitalize">{admin.firstName}</p>
                    <p className="text-[10px] text-emerald-600 font-bold">Admin</p>
                  </div>
                )}
                ...
                <div className="absolute right-0 mt-2 w-60 bg-white rounded-2xl shadow-xl shadow-slate-200/70 border border-slate-100 py-2 z-50">
                  ...
                  <div className="px-4 py-3 border-b border-slate-100 mb-1">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#111827] flex items-center justify-center text-white text-[13px] font-extrabold flex-shrink-0">
                        {initials}
                      </div>
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-emerald-600 font-semibold">TnP Administrator</p>
