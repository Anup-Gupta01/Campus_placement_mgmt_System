...
function getScoreColor(score: number) {
  ...
  if (score >= 65) return { text: "#059669", glow: "shadow-emerald-500/20",  bar: "from-emerald-500-400 to-blue-500",    label: "Good",       ring: "#059669" };
  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[700px] h-[700px] rounded-full bg-[#1F2937]/20 blur-[140px]" />
        <div className="absolute top-[10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-slate-800/40 blur-[120px]" />
        <div className="absolute bottom-[-10%] left-[30%] w-[500px] h-[500px] rounded-full bg-[#1F2937]/20 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 border-b border-white/5 bg-white/[0.02] backdrop-blur-sm">
        <div className="max-w-5xl mx-auto px-5 sm:px-8 py-5">
          ...
          <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-[#111827] flex items-center justify-center shadow-md shadow-black/20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8 py-10">
          ...
          <>
            ...
            <div
              ...
              className={`relative rounded-3xl p-1 mb-8 transition-all duration-300 ${
                isDragging
                  ? "bg-gradient-to-br from-[#1F2937]/20 to-[#1F2937]/10"
                  : "bg-gradient-to-br from-white/5 to-white/[0.02]"
              }`}
            >
              <div className={`rounded-[22px] border-2 border-dashed transition-all duration-300 p-10 sm:p-16 text-center ${
                isDragging ? "border-indigo-400 bg-emerald-500/10" : "border-white/10 hover:border-white/20 bg-black/20"
              }`}>
                {file ? (
                    ...
                    {loading && (
                      <div className="w-full max-w-sm mb-8">
                        ...
                        <div className="h-1.5 w-full bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full rounded-full bg-gradient-to-r from-emerald-500 via-emerald-400 to-emerald-300 transition-all duration-300"
                    ...
                    {!loading && (
                      <>
                        ...
                        >
                          ...
                          <div className="absolute inset-0 bg-[#1F2937] opacity-0 group-hover:opacity-100 transition-opacity" />
                          <div className="absolute inset-0 rounded-2xl shadow-lg shadow-black/20 group-hover:shadow-black/30 transition-shadow" />
                  ...
                  <>
                      <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#1F2937]/25 to-[#1F2937]/15 border border-white/10 flex items-center justify-center mx-auto mb-6 shadow-inner">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-[#047857] opacity-0 group-hover:opacity-100 transition-opacity" />
                      <span className="relative flex items-center gap-2">
            ...
            {!loading && (
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
                {[
                  { icon: <ShieldCheck className="w-5 h-5 text-emerald-400" />, title: "ATS Optimization", desc: "Pass applicant tracking systems" },
                  { icon: <Lightbulb className="w-5 h-5 text-emerald-400" />, title: "Smart Suggestions", desc: "AI-powered improvement tips" },
                  { icon: <Zap className="w-5 h-5 text-slate-400" />, title: "Role Matching", desc: "Find your best-fit job roles" },
                ].map((f, i) => (
        ...
        {analysis && mainScore && (
          <div className="space-y-5">
            ...
            {/* ── Score hero card ── */}
              <div className="relative rounded-3xl overflow-hidden p-1 bg-gradient-to-br from-[#1F2937]/25 via-[#1F2937]/15 to-slate-800/10">
                <div className="rounded-[22px] bg-slate-950 border border-white/5 p-7 sm:p-10">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-[#059669] text-white text-[12px] font-bold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-black/10">
